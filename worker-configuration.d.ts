/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d58d38c1179e83c674768b450f43220)
// Runtime types generated with workerd@1.20260828.1 2026-08-23 enable_request_signal
interface __BaseEnv_Env {
	VISITOR_ANALYTICS: D1Database;
	ASK_NHAN_METRICS: AnalyticsEngineDataset;
	ASK_NHAN_RATE_LIMIT: RateLimit;
	VISITOR_RATE_LIMIT: RateLimit;
	XNHAN_RATE_LIMIT: RateLimit;
	XNHAN_INFERENCE_RATE_LIMIT: RateLimit;
	SECURITIES_RATE_LIMIT: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECURITIES_SHARED_MODE" | "OPENAI_API_KEY" | "OPENROUTER_API_KEY">> {}
}
