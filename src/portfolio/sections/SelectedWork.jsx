                ...
                <details className="case-disclosure">
                  <summary>
                    <span className="case-open-label">
                      {copy.work.labels.explore}
                    </span>
                    <span className="case-close-label">
                      {copy.work.labels.collapse}
                    </span>
                  ...
                  <div className="case-disclosure-body">
                    ...
                    >
                      <h4 id={`case-flow-${item.slug}`}>
                        {copy.work.labels.flow}
                      </h4>
                      <ol>
