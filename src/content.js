...
export const content = {
  en: {
    ...
    hero: {
      ...
      statement:
        "I build applied AI systems with business teams, from requirements and model workflows to APIs, testing, integration, and reliable operation.",
    ...
    product: {
      ...
      name: "X Nhân",
      badge: "New",
      title: "From one question to the original conversation.",
      body:
    ...
    securitiesProduct: {
      name: "Nhân for Securities",
      eyebrow: "Company research",
      title: "Understand the business. Follow the evidence.",
      body: "Read Vietnamese company reports, compare financial periods and review the evidence behind each figure. Keep your analysis in a versioned dossier, ready to review and export.",
      primary: "Open research workspace",
      boundary: "Independent personal product · Public company sources · No trading or investment recommendations",
    },
    contact: {
      eyebrow: "Contact",
      title: "Let’s talk",
  ...
  vi: {
    ...
    hero: {
      ...
      statement:
        "Tôi cùng đơn vị nghiệp vụ xây dựng hệ thống AI ứng dụng, từ yêu cầu và luồng mô hình đến API, kiểm thử, tích hợp và vận hành tin cậy.",
    ...
    work: {
      ...
      labels: {
        ...
        flow: "Luồng hệ thống",
        explore: "Khám phá chi tiết dự án",
        collapse: "Thu gọn chi tiết dự án",
        stack: "Công nghệ",
      },
      items: [
        {
    ...
    product: {
      ...
      name: "X Nhân",
      badge: "Mới",
      title: "Từ một câu hỏi đến cuộc thảo luận gốc.",
      body:
    ...
    securitiesProduct: {
      name: "Nhân for Securities",
      eyebrow: "Phân tích doanh nghiệp",
      title: "Hiểu doanh nghiệp từ những bằng chứng.",
      body: "Đọc báo cáo doanh nghiệp Việt Nam, đối chiếu các kỳ và kiểm tra nguồn của từng chỉ tiêu. Giữ phân tích trong hồ sơ có phiên bản, sẵn sàng để rà soát và xuất file.",
      primary: "Mở không gian phân tích",
      boundary: "Sản phẩm cá nhân độc lập · Nguồn doanh nghiệp công khai · Không giao dịch hay khuyến nghị đầu tư",
    },
    contact: {
      eyebrow: "Liên hệ",
